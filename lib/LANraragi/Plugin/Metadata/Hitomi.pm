...
sub plugin_info {
    ...
    return (
        ...
        author      => "doublewelp",
        version     => "0.2",
        description => "在 Hitomi.la 中搜索与您的存档匹配的标签. 
          <br>支持从格式为的文件中读取 ID如 \"{Id} 标题\" (括号可选)
		  <br><i class='fa fa-exclamation-circle'></i> 此插件将使用该档案的 source: tag （如果存在） (ex.: source:https://hitomi.la/XXXXX/XXXXX).",
        parameters => [],
        icon       =>
